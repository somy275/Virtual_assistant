...
import jarvis from "./assets/iron-man-jarvis-desktop-l35dno2i63e8fd7m.jpg"
import listen from "./assets/3459e0e117b5d35a51aef0cf1e443831.gif"
const Virtualai = () => {
  const ref = useRef();
  const ref1 = useRef();
  const ref2 = useRef();
  ...
  return (
    ...
    <img src={jarvis} className="w-[auto] h-[max(50%,100vw)] lg:h-[77%] min-[450px]:bottom-[max(-10em,3vw)] max-h-[50rem] bottom-[-7%] relative lg:bottom-[1rem] object-cover bg-center" alt="Jarvis"></img>
<img ref={ref} src={listen} className="absolute bottom-[18%] min-[450px]:bottom-[7%] h-[20%] w-[auto] min-[450px]:h-[max(12rem,18vw)] min-[450px]:max-h-[18rem] lg:h-[calc(8rem+1vw)] lg:max-h-[12rem] lg:min-h-[7rem] min-[450px]:min-h-[12rem] object-cover hidden" alt="listening"></img>
